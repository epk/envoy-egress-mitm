...
func createCert(sni string) error {
	...
	if err != nil {
		log.Println("Error creating cert dir:", err)
		return err
	}
	...
	log.Println("Running cmd", cfsslCmd.String())
	...
	log.Println("Running cmd", cfssljsonCmd.String())
